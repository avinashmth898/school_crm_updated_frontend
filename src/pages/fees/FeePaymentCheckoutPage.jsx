...
export default function FeePaymentCheckoutPage() {
  ...
  // =========================================================
  // 🔹 Academic Months (July → Current Month)
  // =========================================================
  ...
  // =========================================================
  // 🔹 Merge DB ledger with expected academic months
  // =========================================================
  const getMonthData = (month, year) => {
    ...
    // Missing ledger → treat as due
    return {
      id: `${month}-${year}`,
      month,
      year,
      totalAmount: student?.monthlyFee || 0, // fallback if not in DB
      paidAmount: 0,
      status: "DUE"
    };
  };
